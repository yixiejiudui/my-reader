...
class ReadAloudDialog : BaseDialogFragment(R.layout.dialog_read_aloud) {
    ...
    override fun onFragmentCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.run {
            ...
            tvRewind15.setTextColor(textColor)
            tvFastForward15.setTextColor(textColor)
    ...
    private fun initEvent() = binding.run {
        ...
        tvRewind15.setOnClickListener { ReadAloud.rewind15(requireContext()) }
        tvFastForward15.setOnClickListener { ReadAloud.fastForward15(requireContext()) }
